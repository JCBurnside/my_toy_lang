...
@9 = constant [4 x i8] c"main"
@10 = constant [12 x i8] c"hello there\0A"
...
11:                                               ; preds = %start, %7, %3
  %12 = alloca %str, align 8
  store %str { i8* getelementptr inbounds ([4 x i8], [4 x i8]* @9, i32 0, i32 0), i8* getelementptr inbounds ([4 x i8], [4 x i8]* @9, i64 1, i32 0) }, %str* %12, align 8
  %13 = load i8*, i8** getelementptr inbounds ({ i8* }, { i8* }* @print_str, i32 0, i32 0), align 8
  %14 = bitcast i8* %13 to void ({ i8* }*, %str*)*
  call void %14({ i8* }* @print_str, %str* %12)
  %15 = load i8*, i8** getelementptr inbounds ({ i8* }, { i8* }* @"jit::test::show_short_curicuit", i32 0, i32 0), align 8
  %16 = bitcast i8* %15 to void ({ i8* }*, {}*)*
  call void %16({ i8* }* @"jit::test::show_short_curicuit", {}* @"()")
  br label %ret
...
define i1 @"jit::test::show_something.8"({ i8* }* %0, {} %1) {
arg_declarations:
  %ret = alloca i1, align 1
  %_ = alloca {}, align 8
  store {} %1, {}* %_, align 1
...
start:                                            ; preds = %arg_declarations
  %2 = alloca %str, align 8
  store %str { i8* getelementptr inbounds ([12 x i8], [12 x i8]* @10, i32 0, i32 0), i8* getelementptr inbounds ([12 x i8], [12 x i8]* @10, i64 1, i32 0) }, %str* %2, align 8
  %3 = load i8*, i8** getelementptr inbounds ({ i8* }, { i8* }* @print_str, i32 0, i32 0), align 8
  %4 = bitcast i8* %3 to void ({ i8* }*, %str*)*
  call void %4({ i8* }* @print_str, %str* %2)
